...
static const char *MALKUR_IMPL =
    ...
    "static inline bool  _olrn_mk_pad_btn_released(int32_t id, int32_t btn) {\n"
    "    if (id < 0 || id >= 4 || btn < 0 || btn >= SDL_CONTROLLER_BUTTON_MAX) return false;\n"
    "    return !_mk.pad_btn_cur[id][btn] && _mk.pad_btn_prev[id][btn]; }\n"
    ...
    "static inline int32_t _olrn_mk_pad_count() {\n"
    "    int32_t n = 0;\n"
    "    for (int i = 0; i < 4; i++) if (_mk.pads[i]) n++;\n"
    "    return n; }\n"
    "static inline std::string _olrn_mk_pad_name(int32_t id) {\n"
    ...
    "static inline void _olrn_mk_draw_orb(float cx, float cy, float r,\n"
    ...
    "        px2 = nx; py2 = ny2;\n"
    "    } }\n"
    "static inline void _olrn_mk_pad_rumble(int32_t id, float low, float high, int32_t ms) {\n"
    ...
    "/* ── TTF fonts (SDL_ttf) ─────────────────────────────────────────── */\n"
    "static inline int64_t _olrn_mk_load_font(const std::string& path, int32_t size) {\n"
    "    TTF_Font* f = TTF_OpenFont(path.c_str(), size);\n"
    "    return f ? (int64_t)(uintptr_t)f : 0; }\n"
    "static inline void _olrn_mk_unload_font(int64_t handle) {\n"
    "    if (handle) TTF_CloseFont((TTF_Font*)(uintptr_t)handle); }\n"
    "static inline void _olrn_mk_draw_text_ex(int64_t handle, const std::string& text,\n"
    ...
    "static inline Vec2 _olrn_mk_measure_text_ex(int64_t handle, const std::string& text,\n"
