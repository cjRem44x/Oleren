...
- [The Compiler CLI](getting-started/cli.md)
...
- [Enums & Unions](language/enums-unions.md)
- [Error Handling](language/error-handling.md)
- [Pointers & Memory](language/pointers.md)
...
- [I/O](builtins/io.md)
- [Memory](builtins/memory.md)
- [Math & Casting](builtins/math.md)
...
- [Operator Precedence](appendix/operators.md)
